...
require (
	...
	k8s.io/apiserver v0.0.0-20260121220415-ef6c7943f8e7
	...
	k8s.io/controller-manager v0.0.0-20260121223158-c56a66e132d1
...
require (
	...
	k8s.io/kms v0.0.0-20260121215807-b98a3981434c // indirect
