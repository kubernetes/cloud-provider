...
require (
	...
	k8s.io/apiserver v0.0.0-20210723223822-ce3fb658390c
	k8s.io/client-go v0.0.0-20210720142725-ac207faedfb6
	k8s.io/component-base v0.0.0-20210708095030-632996df852a
	k8s.io/controller-manager v0.0.0-20210723230201-63c27d032053
...
replace (
	...
	k8s.io/apiserver => k8s.io/apiserver v0.0.0-20210723223822-ce3fb658390c
	...
	k8s.io/controller-manager => k8s.io/controller-manager v0.0.0-20210723230201-63c27d032053
)
