...
require (
	...
	k8s.io/api v0.0.0-20230425014824-58b48e270c02
...
require (
	...
	k8s.io/kms v0.0.0-20230424222535-bed3fdf2be1f // indirect
...
replace (
	k8s.io/api => k8s.io/api v0.0.0-20230425014824-58b48e270c02
