...
require (
	...
	k8s.io/controller-manager v0.22.0-beta.0
...
replace (
	...
	k8s.io/apiserver => k8s.io/apiserver v0.22.0-beta.0
	k8s.io/client-go => k8s.io/client-go v0.22.0-beta.0
	k8s.io/component-base => k8s.io/component-base v0.22.0-beta.0
	k8s.io/controller-manager => k8s.io/controller-manager v0.22.0-beta.0
)
