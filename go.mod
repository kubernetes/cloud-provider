...
require (
	...
	k8s.io/apiserver v0.0.0-20250520155923-2055ba24cd4b
	...
	k8s.io/controller-manager v0.0.0-20250520162632-7eda5b2f34ae
...
require (
	...
	k8s.io/kms v0.0.0-20250520155410-738cf8b6bc70 // indirect
