...
require (
	...
	k8s.io/component-helpers v0.0.0-20250319054646-22a0e0b2466c
	k8s.io/controller-manager v0.0.0-20250319061936-f7116369037b
...
require (
	...
	k8s.io/kms v0.0.0-20250308014716-89c23671c056 // indirect
