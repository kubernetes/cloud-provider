...
require (
	...
	k8s.io/component-helpers v0.28.0-alpha.0
	k8s.io/controller-manager v0.28.0-alpha.0
...
replace (
	...
	k8s.io/component-helpers => k8s.io/component-helpers v0.28.0-alpha.0
	k8s.io/controller-manager => k8s.io/controller-manager v0.28.0-alpha.0
