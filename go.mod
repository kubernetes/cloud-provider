...
require (
	...
	k8s.io/component-helpers v0.24.12
	k8s.io/controller-manager v0.24.12
...
replace (
	...
	k8s.io/apiserver => k8s.io/apiserver v0.24.12
	...
	k8s.io/controller-manager => k8s.io/controller-manager v0.24.12
)
