...
require (
	...
	k8s.io/apiserver v0.0.0-20230215121158-019815a2d6e5
	...
	k8s.io/controller-manager v0.0.0-20230215142346-1d9bfae7ea99
...
require (
	...
	k8s.io/kms v0.0.0-20230215120705-719d0c6e6f5b // indirect
