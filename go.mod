...
require (
	...
	k8s.io/component-helpers v0.25.13
	k8s.io/controller-manager v0.25.13
...
replace (
	...
	k8s.io/component-helpers => k8s.io/component-helpers v0.25.13
	k8s.io/controller-manager => k8s.io/controller-manager v0.25.13
)
