...
require (
	...
	k8s.io/apiserver v0.0.0-20220727201618-ffadbb2b55ef
	...
	k8s.io/controller-manager v0.0.0-20220727203249-7d4bab9b18c0
...
replace (
	...
	k8s.io/apiserver => k8s.io/apiserver v0.0.0-20220727201618-ffadbb2b55ef
