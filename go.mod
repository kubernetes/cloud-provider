...
require (
	...
	k8s.io/component-helpers v0.25.14
	k8s.io/controller-manager v0.25.14
...
replace (
	...
	k8s.io/component-helpers => k8s.io/component-helpers v0.25.14
	k8s.io/controller-manager => k8s.io/controller-manager v0.25.14
)
